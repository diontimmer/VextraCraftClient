...
public class ChunkHolder {
   ...
   public void sendChanges(Chunk chunkIn) {
      if (this.changedBlocks != 0 || this.skyLightChangeMask != 0 || this.blockLightChangeMask != 0) {
         ...
         if (this.changedBlocks < 64 && (this.skyLightChangeMask != 0 || this.blockLightChangeMask != 0)) {
         ...
         if (this.changedBlocks == 1) {
            ...
            if (world.getBlockState(blockpos).getBlock().func_235695_q_()) {
            ...
            for(int l = 0; l < this.changedBlocks; ++l) {
               ...
               if (world.getBlockState(blockpos1).getBlock().func_235695_q_()) {
