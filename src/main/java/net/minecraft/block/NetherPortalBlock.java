   ...
   public static class Size {
      ...
      protected int getDistanceUntilEdge(BlockPos pos, Direction directionIn) {
         ...
         for(i = 0; i < 22; ++i) {
            ...
            if (!this.func_196900_a(this.world.getBlockState(blockpos)) || !this.world.getBlockState(blockpos.down()).isIn(Blocks.OBSIDIAN)) {
               break;
            }
         }

         return this.world.getBlockState(pos.offset(directionIn, i)).isIn(Blocks.OBSIDIAN) ? i : 0;
      }
      ...
      protected int calculatePortalHeight() {
         ...
         for(this.height = 0; this.height < 21; ++this.height) {
            for(int i = 0; i < this.width; ++i) {
               ...
               if (i == 0) {
                  if (!this.world.getBlockState(blockpos.offset(this.leftDir)).isIn(Blocks.OBSIDIAN)) {
                     break label56;
                  }
               } else if (i == this.width - 1 && !this.world.getBlockState(blockpos.offset(this.rightDir)).isIn(Blocks.OBSIDIAN)) {
                  break label56;
               }
            }
         }
         ...
         for(int j = 0; j < this.width; ++j) {
            if (!this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).isIn(Blocks.OBSIDIAN)) {
               this.height = 0;
               break;
            }
         }
