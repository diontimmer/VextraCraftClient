...
public class RedstoneWireBlock extends Block {
   ...
   private RedstoneSide func_235545_a_(IBlockReader p_235545_1_, BlockPos p_235545_2_, Direction p_235545_3_, boolean p_235545_4_) {
      ...
      if (p_235545_4_) {
         ...
         if (flag && canConnectUpwardsTo(p_235545_1_.getBlockState(blockpos.up()))) {
      ...
      return !canConnectTo(blockstate, p_235545_3_) && (blockstate.isNormalCube(p_235545_1_, blockpos) || !canConnectUpwardsTo(p_235545_1_.getBlockState(blockpos.down()))) ? RedstoneSide.NONE : RedstoneSide.SIDE;
   }
